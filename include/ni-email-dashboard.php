  ...
  if( !class_exists( 'ni_email_dashboard' ) ) {
	...
	class ni_email_dashboard  extends ni_sales_report_email_function{
        ...
        <div class="container-fluid" id="niwooer">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="card bg-rgba-green-slight">
                            <div class="card-header bg-rgba-green-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'niwooer'); ?> </div>
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-green-strong">Buy Ni WooCommerce Sales Report Pro $24.00</h2>
                                   ...
                                   <div  class="col-md-3">
                                           ...
                                           <i class="fa fa-envelope fa-2x color-rgba-green-strong p-1" aria-hidden="true"></i><a href="mailto:support@naziinfotech.com" target="_blank" class="color-rgba-green-strong">support@naziinfotech.com</a>
                     <br />
                      <i class="fa fa-globe fa-2x color-rgba-green-strong p-1" aria-hidden="true"></i><a href="http://naziinfotech.com/" target="_blank" class="color-rgba-green-strong">http://www.naziinfotech.com</a>
                    ...
                    <div class="carousel-item">
                        <div class="card bg-rgba-cyan-slight">
                            <div class="card-header bg-rgba-cyan-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'niwooer'); ?> </div>
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-cyan-strong">Buy Ni WooCommerce cost of goods Pro @ $34.00</h2>
                                   ...
                                   <div  class="col-md-3">
                                   		<h5> <span class="font-weight-bold" >Coupon Code: <span class="text-warning">ni10</span>  Get 10% OFF</span></h5> 
                                         <i class="fa fa-envelope fa-2x color-rgba-cyan-strong p-1" aria-hidden="true"></i><a href="mailto:support@naziinfotech.com" target="_blank" class="color-rgba-cyan-strong">support@naziinfotech.com</a>
                     <br />
                      <i class="fa fa-globe fa-2x color-rgba-cyan-strong p-1" aria-hidden="true"></i><a href="http://naziinfotech.com/" target="_blank" class="color-rgba-cyan-strong">http://www.naziinfotech.com</a>
                                   </div>
                                </div>
                                <div class="text-right">
                    ...
                    <div class="carousel-item">
                        <div class="card bg-rgba-indigo-slight">
                            <div class="card-header bg-rgba-indigo-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'niwooer'); ?> </div>
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-indigo-strong"> <?php _e('Buy Ni WooCommerce Product Enquiry Pro @ $24.00', 'niwooer'); ?> </h2>
                               	<div class="row" style="font-size:16px">
                                	<div  class="col-md-3">
                                    	<span class="font-weight-bold color-rgba-black-strong"><?php esc_html_e('Dashboard Summary (Today, Total Enquiry)', 'niwooer'); ?></span><br />
                                   ...
                                   <div  class="col-md-3">
                                   		<h5> <span class="font-weight-bold" >Coupon Code: <span class="text-warning">ni10</span>  Get 10% OFF</span></h5> 
                                       <i class="fa fa-envelope fa-2x color-rgba-indigo-strong p-1" aria-hidden="true"></i><a href="mailto:support@naziinfotech.com" target="_blank" class="color-rgba-indigo-strong">support@naziinfotech.com</a>
                     <br />
                      <i class="fa fa-globe fa-2x color-rgba-indigo-strong p-1" aria-hidden="true"></i><a href="http://naziinfotech.com/" target="_blank" class="color-rgba-indigo-strong">http://www.naziinfotech.com</a>
                                   </div>
                                </div>
                                <div class="text-right">
                    ...
                    <div class="carousel-item">
                        <div class="card bg-rgba-blue-slight">
                            <div class="card-header bg-rgba-blue-strong"> <?php _e('Monitor your sales and grow your online business with naziinfotech plugins', 'niwooer'); ?> </div>
                            <div class="card-body">
                                <h2 class="card-title text-center color-rgba-blue-strong"> <?php _e('Ni One Page Inventory Management System For WooCommerce', 'niwooer'); ?> </h2>
                               	<div class="row" style="font-size:16px">
                                	<div  class="col-md-3">
                                    	<span class="font-weight-bold color-rgba-black-strong"><?php esc_html_e('Dashboard Summary stock status', 'niwooer'); ?></span><br />
                                   ...
                                   <div  class="col-md-3">
                                   		 <i class="fa fa-envelope fa-2x color-rgba-blue-strong p-1" aria-hidden="true"></i><a href="mailto:support@naziinfotech.com" target="_blank" class="color-rgba-blue-strong">support@naziinfotech.com</a>
                                     <br />
                                      <i class="fa fa-globe fa-2x color-rgba-blue-strong p-1" aria-hidden="true"></i><a href="http://naziinfotech.com/" target="_blank" class="color-rgba-blue-strong">http://www.naziinfotech.com</a>
                                   </div>
                                </div>
                                <div class="text-right">
            	...
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                        <?php _e('Monitor your sales and grow your online business', 'niwooer'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
            ...
            <div class="row" >
            	<div class="col-md-12">
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                        <?php _e('Dashboard - Sales Analysis', 'niwooer'); ?>
                      </div>
                      <div class="card-body"> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-4 bg-white rounded">
                                  <div class="card-body card-body-padding" >
									...
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Sales', 'niwooer'); ?></strong></h6>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Year Sales', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Month Sales', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Week Sales', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Yesterday Sales', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Sales Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Year Sales Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Month Sales Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('This Week Sales Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box8">
							  <div class="card card-border-top card-border-top-box8  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Yesterday Sales Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                        <?php _e('Customer Analysis', 'niwooer'); ?> 
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Total Customer Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Customer Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Total Guest Customer Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Guest Cust. Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                       <?php _e('Today  Sales Analysis', 'niwooer'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Today Order Count', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Sales', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Product Sold', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Discount', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                           ...
                           <div class="col-xl-3 col-md-6 col-lg-4   box6">
							  <div class="card card-border-top card-border-top-box6  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Today Tax', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                        ...
                        <div class="row">
                           <div class="col-xl-3 col-md-6 col-lg-4   box10">
							  <div class="card card-border-top card-border-top-box10  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong> <?php _e('Low in stock', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box1">
							  <div class="card card-border-top card-border-top-box1  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Out of stock', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
						   ...
						   <div class="col-xl-3 col-md-6 col-lg-4   box4">
							  <div class="card card-border-top card-border-top-box4  shadow p-3 mb-5 bg-white rounded">
                                  <div class="card-body card-body-padding">
                                  	<div class="card-block">
									<h6 class="m-b-20" style="font-size: 14px; text-transform: uppercase"><strong><?php _e('Most Stocked', 'niwooer'); ?></strong></h6>
									<p class="text-right"><span>&nbsp;</span></p>
                      ...
                      <div class="card-body "> 
                        <div class="row">
                    	 ...
                    	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                        	<tr>
                           <th><?php _e( 'Order ID', 'niwooer'); ?></th>
                            <th><?php _e( 'Order Date', 'niwooer'); ?> </th>
                            <th><?php _e( 'First Name', 'niwooer'); ?> </th>
                            <th><?php _e( 'Billing Email', 'niwooer'); ?></th>
                            <th><?php _e( 'Country', 'niwooer'); ?> </th>
                            <th><?php _e( 'Order Status', 'niwooer'); ?>  </th>
                            <th><?php _e( 'Currency', 'niwooer'); ?> </th>
                            <th class="text-right"><?php _e( 'Order Total', 'niwooer'); ?>  </th>
						</tr>
                        </thead>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive niwooer-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e('Order Status', 'niwooer'); ?></th>
                                <th><?php _e('Order Count', 'niwooer'); ?></th>
                                <th><?php _e('Order Total', 'niwooer'); ?></th>
                            	</tr>
                            </thead>
            ...
            <div class="row" >
            	<div class="col-md-12" >
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                    <?php _e('payment gateway', 'niwooer'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="table-responsive niwooer-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e( 'Payment Method', 'niwooer'); ?> </th>
                                <th><?php _e( 'Order Count', 'niwooer'); ?></th>
                                <th><?php _e( 'Order Total', 'niwooer'); ?></th>
                            </tr>
                            </thead>
            ...
            <div class="row" >
            	<div class="col-md-6"  >
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                    <?php _e('Top 5 Customer Report', 'niwooer'); ?>
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                            ...
                            <div class="table-responsive niwooer-table">
                        	 ...
                        	 <thead class="shadow-sm p-3 mb-5 bg-white rounded">
                            	<tr>
                                <th><?php _e('First Name', 'niwooer'); ?>  </th>
                                <th><?php _e('Email Address', 'niwooer'); ?></th>
                                <th><?php _e('Order Count', 'niwooer'); ?></th>
                                <th><?php _e('Order Total', 'niwooer'); ?></th>
                            </tr>
                            </thead>
							...
							?>
                            <tr>
                            	<td colspan="4"><?php _e('No Customer found', 'niwooer'); ?></td>
                            </tr>
                            <?php
							} 
							 ?>
                ...
                <div class="col-md-6" >
         			<div class="card">
                      <div class="card-header niwooer-plugin-color">
                  <?php _e('TOP 5 Country REPORT', 'niwooer'); ?> 
                      </div>
                      <div class="card-body "> 
                        <div class="row">
                        	<div class="col-sm-12 col-md-12 col-lg-12">
      ...
      MONTH(date_format( posts.post_date, '%Y-%m-%d')) = MONTH(CURRENT_DATE()) ";
		...
		function get_order_status2($period="CUSTOM",$start_date=NULL,$end_date=NULL){
			global $wpdb;
			$query = "
				SELECT 
				posts.ID as order_id
